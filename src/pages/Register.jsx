...
export default function Register() {
  ...
  const handleRegister = async () => {
    ...
    await supabase.from("user").insert({
      ...
      stamp: `Registered on ${new Date().toISOString()}`
    });
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="bg-white p-8 rounded-lg shadow-md w-96 text-center">
          ...
          <Link to="/login" className="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 font-medium">
            Go to Login
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <p className="text-center text-sm text-gray-500 mb-6">Register for HOPE CMS</p>
